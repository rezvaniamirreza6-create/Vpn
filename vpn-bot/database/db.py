...
class User(Base):
    ...
    lottery_number: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)  # شماره قرعه‌کشی
...
class DiscountCode(Base):
    ...
    max_uses: Mapped[int] = mapped_column(Integer, default=1)       # حداکثر استفاده
...
class BotSetting(Base):
    """تنظیمات داینامیک ربات که ادمین تغییر می‌دهد"""
...
if _DATABASE_URL.startswith("sqlite"):
    _DATABASE_URL = _DATABASE_URL.replace("sqlite:///", "sqlite+aiosqlite:///")
